## this function fills holes (0s) less than 3-hours within each storms The data provided is the 
...
# is defined within this function as 3

StormChunk_3hr <- function(PPT) {
  rain_sum1 <-
  ...
  for(i in 1:nrow(Met_data_raw2)) {
    ...
    R_Sum <- data.frame(Met_data_raw2, rain_sum1, rain_sum2, rain_sum3, rain_sum4, storm_occurrence)
